...
def parse_normal_transations_url(account_address, start, page, end=99999999):
    url = f"https://api.blastscan.io/api?module=account&action=txlist&address={account_address}&startblock={start}&endblock={end}&page={page}&offset=100&sort=desc&apikey={BLASTSCAN_API_KEY}"
    return url
